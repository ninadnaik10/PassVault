    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == signupBtn) {
            ...
            try {
                ...
                PreparedStatement PCreatestatement = connection.prepareStatement("create table '" + hashUsername + "'(accId integer primary key autoincrement,"
                        + "        webName varchar(255) not null,"
                        + "        webUsername varchar(255),"
...
//mysql query to run
                String sql = "select * from userCred group by username having username = '" + hashUsername + "' and password = '" + hashPassword + "'";
